...
export default function FeaturedVideoSection({ stripeUrl }: Props) {
    ...
    <section className="pt-6 md:pt-10 pb-20 md:pb-32 px-6 overflow-hidden">
      <div ref={ref} className="max-w-6xl mx-auto">
        ...
        >
          ...
          {/* Gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-t from-deep-space/80 via-transparent to-transparent pointer-events-none" />
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 flex flex-col md:flex-row items-end justify-between gap-4">
            ...
            <div className="liquid-glass rounded-2xl p-6 md:p-8 max-w-md w-full md:w-auto">
              <p className="text-cream/50 text-xs tracking-widest uppercase mb-3 font-body">
                What Your Reading Reveals
              </p>
              <p className="text-cream text-sm md:text-base leading-relaxed font-body">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="liquid-glass rounded-full px-8 py-3 text-cream text-sm font-medium hover:bg-gold/5 transition-colors whitespace-nowrap cursor-pointer flex-shrink-0"
            >
              Get My Reading →
            </motion.a>
          </div>
